...
public class SimpleServletByPath extends SlingSafeMethodsServlet {
  ...
  @Reference
    ...
    protected void doGet(final SlingHttpServletRequest req,
        ...
        String simpleservice=si.getHelloWorld();
        logger.info("-------custom configs data in servlet logs----"+simpleservice);
        logger.info("-------custom configs data in servlet logs----"+userName);
        resp.getWriter().write(simpleservice+"User Name ="+userName);
    }
}
